...
A **hybrid web and mobile application** designed to simplify **hostel delivery coordination** and **daily expense tracking** for students.  
It integrates **Flutter**, **Laravel**, **MySQL**, and **Razorpay API** to automate campus deliveries, ensure secure payments, and provide transparent tracking between **students**, **agents**, and **administrators**.
...
- View **payment logs** and **expense summaries**
...
|-------|------------------|-------------|
| **Frontend (Mobile)** | Flutter (Dart) | Cross-platform student & agent mobile app |
| **Backend** | Laravel (PHP) | RESTful API development and business logic |
| **Database** | MySQL | Secure relational data storage |
| **Payment Gateway** | Razorpay API | UPI, card, and net banking integration |
...
*(See `/screenshots` folder for sample images)*
